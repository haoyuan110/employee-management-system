...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'employee/add', name: 'AddEmployee', component: AddEmployeeView, meta: { roles: ['admin', 'manager'] } },
            { path: 'employee/roles', name: 'RoleManage', component: RoleManageView, meta: { roles: ['admin'] } },
            { path: 'overtime', name: 'Overtime', component: OvertimeView },
            { path: 'overtime/apply', name: 'OvertimeApply', component: OvertimeApplyView },
            { path: 'overtime/approve', name: 'OvertimeApprove', component: OvertimeApproveView, meta: { roles: ['admin', 'manager'] } },
            { path: 'statistics', name: 'Statistics', component: StatisticsView, meta: { roles: ['admin', 'manager'] } },
            ...
            { path: 'business/apply', name: 'BusinessApply', component: BusinessApplyView },
            { path: 'notice', name: 'Notice', component: NoticeView },
            { path: 'notice/detail/:id', name: 'NoticeDetail', component: NoticeDetailView }
        ]
    },
    {
        path: '/:pathMatch(.*)*',
